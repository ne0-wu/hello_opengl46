...
class Dijkstra {
 public:
  ...
  static Dijkstra compute(Args&&... args) {
    static_assert(std::is_constructible_v<Dijkstra, Args...>,
                  "Invalid arguments for Dijkstra construction");
 ...
 private:
  ...
  Mesh::VProp<double> distance;
  Mesh::VProp<Mesh::VertexHandle> previous;
};